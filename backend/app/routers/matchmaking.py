...
async def get_public_stats(db: Session = Depends(get_db)):
    ...
    if top_history and len(top_history) > 0:
        ...
        top_duos_list = [
          { "id": 1, "player1": "PrincessPinkyUp#8ï8", "player1Name": "Julie", "player1Avatar": "/avatars/julie.jpg", "player2": "Lesbian princess#UwU", "player2Name": "Alanood", "player2Avatar": "/avatars/alanood.jpg", "score": 96, "archetype": "💎 High Elo Duo", "winrate": "76%", "games": 38 },
          { "id": 2, "player1": "PrincessDarkyUp#8ï8", "player1Name": "Ismael", "player1Avatar": "https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/profile-icons/6868.jpg", "player2": "PrincessPinkyUp#8ï8", "player2Name": "Julie", "player2Avatar": "/avatars/julie.jpg", "score": 93, "archetype": "🔥 Mastermind Duo", "winrate": "70%", "games": 28 },
